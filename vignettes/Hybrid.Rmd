...
```{r}
solve_dAoYda(5/365, foiP3, Tmax=5*365, dt=5) -> mt
```
...
The errors are minor -- the difference between the two methods is at most a few days. 

```{r, fig.height=4, fig.width=6, echo=F}
plot(moment1y-mt$y, type = "l", xlab = "Age (in Days)", ylab = "Errors")
```
