...
In the following, we review the mathematical formulas and the functions in `pf.memory` that compute the multiplicity of infection (MoI), the age of infection (AoI), and the age of the youngest infection (AoY). 
