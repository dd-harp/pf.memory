...
subtitle: "The Multiplicity and Age of Infection"
...
In the following, we present functions to compute the distribution of the multiplicity and age of infection.
...
plot(a3years, f_A, type ="l", 
     xlab = expression(list(alpha, paste("Parasite Age (in Days)"))), 
     ylab = expression(f[A](alpha)), ylim = range(f_A))
```
...
moment3 = momentAoI(a3years0, foiP3, n=3)
```
...
plot(a3years0, moment1, type = "l", xlab = "a - Host Age (in Days)", 
     lwd=2, ylim = range((moment3)^(1/3)),
     ylab = expression(list(x, sqrt(x[paste("[2]")]), sqrt(x[paste("[3]")], 3))))

lines(a3years0, sqrt(moment2), col = "darkgreen")
lines(a3years0, (moment3)^(1/3), col = "purple")

plot(a3years0, moment2, type = "l", xlab = "a - Host Age (in Days)",
     lwd=2, col = "darkgreen",
     ylab = expression(x[paste("[2]")])) 
mar = c(4, 4, 0.5, 2)
plot(a3years0, moment3, type = "l", xlab = "a - Host Age (in Days)",
     lwd=2, col = "purple", 
